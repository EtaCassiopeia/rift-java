...
/**
 * Internal wiring between the {@link io.github.achirdlabs.rift.dsl.RiftDsl} / {@code
 * RecordedRequest} call sites and the {@link RiftBodyCodec} SPI. Not part of the supported public
 * API — {@link io.github.achirdlabs.rift.dsl.RiftDsl#useBodyCodec} is the entry point callers
...
public final class BodyCodecs {
    ...
    public static RiftBodyCodec resolve() {
        ...
        return discover().orElseThrow(() -> new IllegalStateException(
                "no RiftBodyCodec on the classpath — add io.github.achird-labs:rift-java-jackson"));
    }
