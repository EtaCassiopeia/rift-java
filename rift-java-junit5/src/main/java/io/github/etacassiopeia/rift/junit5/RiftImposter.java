...
/**
 * Marks a {@code static} {@link io.github.etacassiopeia.rift.dsl.ImposterSpec} field declaring an
 ...
 * which every spec created via {@link io.github.etacassiopeia.rift.dsl.RiftDsl#imposter(String)} carries.
 */
